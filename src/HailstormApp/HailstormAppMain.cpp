...
void HailstormAppMain::CreateRenderers(const std::shared_ptr<DX::DeviceResources>& deviceResources)
{
...
void HailstormAppMain::OnWindowSizeChanged()
{
...
void HailstormAppMain::OnSuspending()
{
...
void HailstormAppMain::OnResuming()
{
	// TODO: Replace this with your app's resuming logic.
}

// Notifies renderers that device resources need to be released.
void HailstormAppMain::OnDeviceRemoved()
{
