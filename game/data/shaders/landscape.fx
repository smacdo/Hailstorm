// landscape.fx - Lighting shader for the landscape demo
...
VS_OUT VS( VS_IN vIn )
{
	...
	// Transform to homogeneous clip sace.
...
{
	// Interpolating the normal can make it not be of unit length so normalize it.
...
technique10 LandscapeTechnique
{
	pass P0
	{
